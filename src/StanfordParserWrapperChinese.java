...
public class StanfordParserWrapperChinese {
	...
	GrammaticalStructureFactory gsf = new edu.stanford.nlp.trees.international.pennchinese.ChineseGrammaticalStructureFactory(punctuationFilter);
	...
	if (args.length == 4) {
	    ...
	    System.out.println("Usage: (string) input file simplified chinese, (string) alignment file chinese-foreign, (string) output file, (v[erbose]|q[uiet]) output mode");
	}
    }
}
